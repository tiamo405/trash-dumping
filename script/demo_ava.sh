...
python test_video_ava.py --cuda -d ava_v2.2 -v yowo_v2_large -size 224 --weight checkpoints/ava/yowo_v2_large_ava_k32.pth -K 32 --video trash/New_video/VID_20230310_161738.mp4
